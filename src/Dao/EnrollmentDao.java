...
public class EnrollmentDao {
    ...
    public boolean register(Enrollment inscripcion) {
        try {
            ...
            showAlert("Error", "Ocurrió un error al registrar la inscripción.\n" + e.getMessage(), Alert.AlertType.ERROR);
            e.printStackTrace();
            return false;
        }
    }
    ...
    public List<Enrollment> toList() {
        ...
        try {
            ...
            showAlert("Error", "Ocurrió un error al listar inscripciones.\n" + e.getMessage(), Alert.AlertType.ERROR);
            e.printStackTrace();
        }
    ...
    public boolean edit(Enrollment i) {
        try {
            ...
            showAlert("Error", "Ocurrió un error al editar la inscripción.\n" + e.getMessage(), Alert.AlertType.ERROR);
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean delete(int id) {
        try {
            ...
            showAlert("Error", "Ocurrió un error al eliminar la inscripción.\n" + e.getMessage(), Alert.AlertType.ERROR);
            e.printStackTrace();
            return false;
        }
    }
